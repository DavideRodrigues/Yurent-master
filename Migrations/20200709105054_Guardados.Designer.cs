...
namespace YURent.Migrations
{
    ...
    [Migration("20200709105054_Guardados")]
    partial class Guardados
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YURent.Areas.Identity.Data.Anuncios", b =>
                {
            ...
            modelBuilder.Entity("YURent.Areas.Identity.Data.Guardados", b =>
                {
                    b.Property<int>("Id_guardados")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int?>("AnunciosId_anuncio")
                        .HasColumnType("int");

                    b.Property<int?>("UtilizadorId_utilizador")
                        .HasColumnType("int");

                    b.HasKey("Id_guardados");

                    b.HasIndex("AnunciosId_anuncio");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("YURent.Areas.Identity.Data.YURentUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("YURent.Areas.Identity.Data.Guardados", b =>
                {
                    b.HasOne("YURent.Areas.Identity.Data.Anuncios", "Anuncios")
                        .WithMany()
                        .HasForeignKey("AnunciosId_anuncio");
